...
def IM_sym_fixed_ancGrowth_noMig(params, ns, pts):
    """
    ns = (n1,n2)
    ...
    nu1_0,nu2_0,nu1,nu2,T,Tg,nua = params
    p_misid=0.001
...
func = IM_sym_fixed_ancGrowth_noMig

upper_bound = [1e2, 1e2, 1e2, 1e2, 2, 2, 1e2]
lower_bound = [1e-2, 1e-2, 1e-2, 1e-2, 0, 0, 1e-2]
...
opt_prob.addVar('Tg','c',lower=lower_bound[5],upper=upper_bound[5],value=p1[5])
opt_prob.addVar('nua','c',lower=lower_bound[6],upper=upper_bound[6],value=p1[6])
opt_prob.addObj('f')
...
if myrank == 0:
    ...
    print 'Nref:',Nref
    paramsTxt =['nu1_0','nu2_0','nu1','nu2','T', "Tg", "nua"]
    scaledParams = [Nref*popt[0],Nref*popt[1],Nref*popt[2],Nref*popt[3],2*Nref/gensPerYear*popt[4], 2*Nref/gensPerYear*popt[4]+2*Nref/gensPerYear*popt[5], Nref*popt[6]]
