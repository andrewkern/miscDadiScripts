...
upper_bound = [1e2, 1e2, 1e2, 1e2, 2, 20, 20, 0.05]
lower_bound = [1e-2, 1e-2, 1e-2, 1e-2, 0, 0, 0, 0]
...
opt_prob.addVar('m12','c',lower=lower_bound[5],upper=upper_bound[5],value=p1[5])
opt_prob.addVar('m21','c',lower=lower_bound[6],upper=upper_bound[6],value=p1[6])
...
if myrank == 0:
    ...
    scaledParams = [Nref*popt[0],Nref*popt[1],Nref*popt[2],Nref*popt[3],2*Nref/gensPerYear*popt[4], popt[5], popt[6], popt[7]]
